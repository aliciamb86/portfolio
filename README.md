...
- **[Exploratory Data Analysis: Rental Price Evolution in Spain](https://github.com/aliciamb86/EDA-Rental-Price-Evolution-in-Spain)**  
  ...
  *Highlights*: 
    ...
    - **Data Includes**:
      - **Date**: Month and year of rental price records.
      - **Location**: Specific city or region in Spain.
      - **Price**: Average rental price in euros.
    - **Analysis Steps**:
...
- **Co-Founder and CEO** at Gamma Arquitectos (2014 - 2024)  
  Managed technical execution and data-driven optimization of resources in construction projects using tools like Excel and PowerBI.
